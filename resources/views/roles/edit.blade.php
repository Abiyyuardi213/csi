...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="mb-8">
            <h1 class="text-2xl font-bold tracking-tight text-zinc-950">Edit Role</h1>
            <p class="mt-2 text-sm text-zinc-500">Update permission details for {{ $role->name }}.</p>
        </div>

...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="mb-8">
            <h1 class="text-2xl font-bold tracking-tight text-zinc-950">Add Material</h1>
        </div>
            ...
            <form action="{{ route('materials.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name"
                            ...
                            required placeholder="e.g. Low Sulphur Coal">
                    </div>
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-zinc-950">Code</label>
                        <input type="text" name="code"
                            class="flex h-10 w-full rounded-md border border-zinc-200 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950"
                            placeholder="e.g. LS-COAL">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3"
                        class="flex w-full rounded-md border border-zinc-200 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950"></textarea>
                </div>
